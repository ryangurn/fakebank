@if(isset($users) && $users != null)
    @foreach($users as $user)
        <div class="modal" id="activity_user_{{ $user->id }}" tabindex="-1">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="accordion" id="template_accordion">
                            @if(isset($user->activities) && !$user->activities->isEmpty())
                                @foreach($user->activities()->orderBy('created_at', 'desc')->get() as $activity)
                                    @if($activity->subject_id == $user->id)
                                        <div class="card">
