    ...
    <div class="container">
            ...
            <div class="col-md-10">
                <div class="card">
                    <div class="card-header">
                        <div class="float-left">Update Route: {{ $route->route  }}</div>
        ...
        <div class="row justify-content-center">
            <div class="col-md-10">
                <div class="card">
                    <div class="card-header">
                        <div class="float-left">Delete Route: {{ $route->route }}</div>
                    </div>
                    ...
                    <div class="card-body">
                        <form action="{{ route('route.destroy', $route->id)  }}" method="POST">
                            ...
                            <div class="form-group">
                                <input type="submit" class="form-control btn btn-danger" value="Delete Route" />
                            </div>
                        </form>
