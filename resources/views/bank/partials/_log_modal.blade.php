...
<div class="modal" id="activity_bank_{{ $bank->id }}" tabindex="-1">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Bank Activity Log</h5>
            ...
            <div class="modal-body">
                <div class="accordion" id="template_accordion">
                    @if(isset($bank->activities) && !$bank->activities->isEmpty())
                        @foreach($bank->activities()->orderBy('created_at', 'desc')->get() as $activity)
                            @if($activity->subject_id == $bank->id)
                                <div class="card">
